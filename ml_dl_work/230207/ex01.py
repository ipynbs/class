...
# 35개의 데이터로 학습을 진행하고 14개의 데이터 이 모델을 평가해보겠다
# 49개의 데이터로 최근접이웃 알고리즘 학습을 진행하고 그 학습한 학습기에 대한 평가를 해보세요
knr = KNeighborsClassifier()
# knr.fit()

# train_input = zip(fish_length, fish_weight)
...
in035 = index[:35]  # 35개의 데이터
in3549 = index[35:]  # 35~49개의 데이터
